...
var WindowsPtyAgent = (function () {
    function WindowsPtyAgent(file, args, env, cwd, cols, rows, debug) {
        ...
        var term = pty_node_prebuild_1.default.startProcess(file, commandLine, env, cwd, cols, rows, debug);
        this._pid = term.pid;
    ...
    WindowsPtyAgent.prototype.resize = function (cols, rows) {
        pty_node_prebuild_1.default.resize(this._pid, cols, rows);
    };
    WindowsPtyAgent.prototype.kill = function () {
        ...
        pty_node_prebuild_1.default.kill(this._pid, this._innerPidHandle);
    };
