...
var pty_node_prebuild_1 = require("pty-node-prebuild");
var DEFAULT_FILE = 'sh';
...
var UnixTerminal = (function (_super) {
    ...
    function UnixTerminal(file, args, opt) {
        ...
        var term = pty_node_prebuild_1.default.fork(file, args, parsedEnv, cwd, cols, rows, uid, gid, (encoding === 'utf8'), onexit);
    ...
    UnixTerminal.open = function (opt) {
        ...
        var term = pty_node_prebuild_1.default.open(cols, rows);
    ...
    Object.defineProperty(UnixTerminal.prototype, "process", {
        get: function () {
            return pty_node_prebuild_1.default.process(this.fd, this.pty) || this.file;
        },
        enumerable: true,
        configurable: true
    });
    UnixTerminal.prototype.resize = function (cols, rows) {
        pty_node_prebuild_1.default.resize(this.fd, cols, rows);
    };
